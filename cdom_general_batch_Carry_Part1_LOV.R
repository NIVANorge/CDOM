...
dir.create(paste0("CDOM_2021/","/ind"))
dir.create(paste0("CDOM_2021/", "/results"))
dir.create(paste0("CDOM_2021/", "/processed"))
dir.create(paste0("CDOM_2021/", "/plots"))
dir.create(paste0("CDOM_2021/", "/plots/", "/spectra"))
dir.create(paste0("CDOM_2021/", "/plots/", "/models"))
folderin<-"cdom_2021"
folderout <-"cdom_2021/ind/" 
folderout_results<- "cdom_2021/results/"


#Add logbook (check for latest version on K)
logbook <- read.delim ("log_211129.txt")
